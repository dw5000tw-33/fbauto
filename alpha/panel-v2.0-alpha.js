...
const expandVisible=async()=>{
 ...
 const names=['顯示更多','查看更多','查看更多','更多留言','查看先前留言','顯示更多留言','顯示更多回覆'];
 let clicks=0;
