...
groupScan.onclick=()=>{
  ...
  groupPage=0;renderGroups();setGroupStatus(found.size?'掃描到 '+found.size+' 個可見社團；請勾選本次要使用的社團。':'沒有掃描到社團。請先前往 Facebook「你的社團」頁面再試。',found.size?'ok':'bad');
};
