...
groupAuto.onclick=async()=>{
  ...
  setGroupStatus('自動收集完成：共 '+groupList.length+' 個社團。請分批確認、勾選後再下載 JSON。','ok');
};
